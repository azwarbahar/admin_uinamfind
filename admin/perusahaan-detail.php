...
$id = $_GET['id'];
$result = mysqli_query($conn, "SELECT * FROM tb_perusahaan WHERE id = '$id'");
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="perusahaan.php">Data Perusahaan</a>
                        <li class="active">
                            Detail
                        </li>
                    </ol>
                ...
                <div class="col-lg-4">
                    <div class="card-box">
                        <div class="contact-card">
                            <a class="pull-left" href="#">
                                <img class="img-circle thumb-md" src="https://api.uinamfind.com/upload/perusahaan/<?= $dta['foto'] ?>" alt="<?= $dta['nama'] ?>">
                            </a>
                            <div class="member-info" style="padding-bottom: 0px" ;>
                                <h4 class="m-t-0 m-b-5 header-title"><b><?= $dta['nama'] ?></b></h4>
                                <p class="text-dark"><i class="md md-people m-r-10"></i><small><a href=""><?= $dta['industri'] ?></a></small></p>
                    ...
                    <div class="card-box">
                        ...
                        <div class="text-left">
                            ...
                            ?>
                            <p class="text-muted font-13"><strong>Admin :</strong><a href="recruiter-detail.php?id=<?= $dta_recruiter['id'] ?>"><span class="m-l-15"><?= $dta_recruiter['nama'] ?></span></a></p>
                            <p class="text-muted font-13"><strong>Bidang :</strong><a href="#"><span class="m-l-15"><?= $dta['industri'] ?></span></a></p>
                            <p class="text-muted font-13"><strong>Jumlah Pegawai :</strong><span class="m-l-15"><?= $dta['ukuran_kariawan'] ?> Orang</span></p>
                            <p class="text-muted font-13"><strong>Lokasi :</strong><span class="m-l-15"><?= $dta['lokasi'] ?></span></p>
                            <p class="text-muted font-13"><strong>Kontak :</strong><span class="m-l-15"><?= $dta['telpon'] ?></span></p>
                            <p class="text-muted font-13"><strong>Email :</strong><span class="m-l-15"><?= $dta['email'] ?></span></p>
                            <p class="text-muted font-13"><strong>Website :</strong><a target="_blank" href="<?= $dta['url_profil'] ?>"><span class="m-l-15"><?= $dta['url_profil'] ?></span></a></p>
                            ...
                            <div class="button-list m-t-20">
                                ...
                                $sosmed = mysqli_query($conn, "SELECT * FROM tb_sosmed WHERE kategori = 'UKM' AND from_id = '$dta[id]'");
                    ...
                    <div class="card-box">
                        <?php
                        $get_anggota = mysqli_query($conn, "SELECT * FROM tb_anggota WHERE from_id = '$dta[id]' AND kategori='Perusahaan'");
                        $row_get_anggota = mysqli_num_rows($get_anggota);
                        $row_get_anggota_final = $row_get_anggota;
                        ?>

                        <h4 class="m-t-0 m-b-20 header-title"><b>Mahasiswa/Alumni <span class="text-muted">(<?= $row_get_anggota_final ?>)</span></b></h4>
                        <p style="margin-top: -16px ;" class="font-13">Mahasiswa dan alumni yang bekerja disini</p>
                        ...
                        <div id="bg-post-loker" class="panel-collapse collapse in">
                            <div class="portlet-body">
                                <div class="owl-carousel owl-theme" id="owl-multi">
                                    ...
                                    <?php
                                    $get_foto = mysqli_query($conn, "SELECT * FROM tb_foto WHERE from_id = '$dta[id]' AND kategori='Perusahaan'");
                        ...
                        <div id="bg-post-loker" class="panel-collapse collapse in">
                            <div class="portlet-body">
                                <div class="row">
                                    ...
                                    <?php
                                    $get_kegiatan = mysqli_query($conn, "SELECT * FROM tb_kegiatan WHERE from_id = '$dta[id]' AND kategori='Perusahaan'");
