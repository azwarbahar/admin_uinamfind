                ...
                <div class="col-lg-4">
                    <div class="card-box">
                        <div class="contact-card">
                            ...
                            <div class="member-info" style="padding-bottom: 0px" ;>
                                ...
                                $cakupan = $dta['cakupan_lembaga'];
                                if ($cakupan == "Universitas") {
                                    echo "<p class='text-dark'><i class='md md-business m-r-10'></i><small>$dta[cakupan]</small></p>";
                                } else if ($cakupan == "Fakultas") {
                                    echo "<p class='text-dark'><i class='md md-business m-r-10'></i><small>$dta[fakultas]</small></p>";
                                } else {
                                    echo "<p class='text-dark'><i class='md md-business m-r-10'></i><small>$dta[jurusan]</small></p>
                                    ";
                                }

                                ?>
                                <!-- <p class="text-dark"><i class="md md-business m-r-10"></i><small><?= $dta['jurusan'] ?></small></p> -->
                                <!-- <div class="m-t-20">
                    ...
                    <div class="card-box">
                        ...
                        <div class="text-left">
                            ...
                            <p class="text-muted font-13"><strong>Alamat :</strong> <span class="m-l-15"><?= $dta['alamat_sekretariat'] ?></span></p>
                            <?php
                            if ($cakupan == "Jurusan") {
                                echo "<p class='text-muted font-13'><strong>Fakultas :</strong><a href='#'><span class='m-l-15'>$dta[fakultas]</span></a></p>";
                                echo "<p class='text-muted font-13'><strong>Jurusan :</strong><a href='#'><span class='m-l-15'>$dta[jurusan]</span></a></p>";
                            } else if ($cakupan == "Fakultas") {
                                echo "<p class='text-muted font-13'><strong>Fakultas :</strong><a href='#'><span class='m-l-15'>$dta[fakultas]</span></a></p>";
                            }
                            ?>
                            ...
                            <div class="button-list m-t-20">
                                ...
                                $sosmed = mysqli_query($conn, "SELECT * FROM tb_sosmed WHERE kategori = 'Lembaga' AND from_id = '$dta[id]'");
                    ...
                    <div class="card-box">
                        <?php
                        $get_anggota = mysqli_query($conn, "SELECT * FROM tb_anggota WHERE from_id = '$dta[id]' AND kategori='Lembaga'");
                        ...
                        <div id="bg-post-loker" class="panel-collapse collapse in">
                            <div class="portlet-body">
                                <div class="owl-carousel owl-theme" id="owl-multi">
                                    ...
                                    <?php
                                    $get_foto = mysqli_query($conn, "SELECT * FROM tb_foto WHERE from_id = '$dta[id]' AND kategori='Lembaga'");
                        ...
                        <div id="bg-post-loker" class="panel-collapse collapse in">
                            <div class="portlet-body">
                                <div class="row">
                                    ...
                                    <?php
                                    $get_kegiatan = mysqli_query($conn, "SELECT * FROM tb_kegiatan WHERE from_id = '$dta[id]' AND kategori='Lembaga'");
                                        ...
                                        <div class="col-lg-6">
                                            <div class="blog-box-one">
                                                <div class="cover-wrapper">
                                                    <a href="#"><img alt="Blog-img" src="https://api.uinamfind.com/upload/photo/<?= $dta_get_kegiatan['nama_foto'] ?>" class="img-responsive" /></a>
                                                </div>
                                                <div class="post-info">
