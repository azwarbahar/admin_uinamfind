...
$organisasi = mysqli_query($conn, "SELECT * FROM tb_organisasi");
?>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h4 class="page-title">Data Organisasi dan Komunitas</h4>
                    <ol class="breadcrumb">
                        <li>
                            <a href="#">Master Data</a>
                        </li>
                        <li class="active">
                            Data Organisasi dan Komunitas
                        </li>
                    </ol>
                </div>
            </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="POST" action="controller/controller-organisasi.php" enctype="multipart/form-data">

                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">Nama Organisasi</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="nb-edt form-control" required="" autocomplete="off" placeholder="Nama Organisasi atau Komunitas" name="nama" id="nama">
                                                </div>
                                            </div>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" name="submit_tambah_organisasi" class="btn btn-default waves-effect">Simpan</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                            ...
                            <tbody>
                                ...
                                foreach ($organisasi as $dta) { ?>
                                    <tr>
                                        ...
                                        ?>
                                        <td style="text-align: center;">
                                            <a href="organisasi-detail.php?id=<?= $dta['id'] ?>" class="btn table-action-btn waves-effect waves-light"><i class="md md-visibility"></i></a>
                                        </td>
                                    </tr>
                                <?php $i = $i + 1;
                                } ?>
