...
$id = $_GET['id'];
$result = mysqli_query($conn, "SELECT * FROM tb_ukm WHERE id = '$id'");
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card-box">
                        <?php
                        $get_anggota = mysqli_query($conn, "SELECT * FROM tb_anggota WHERE from_id = '$dta[id]' AND kategori='UKM'");
                        ...
                        <div id="bg-post-loker" class="panel-collapse collapse in">
                            <div class="portlet-body">
                                <div class="owl-carousel owl-theme" id="owl-multi">
                                    ...
                                    <?php
                                    $get_foto = mysqli_query($conn, "SELECT * FROM tb_foto WHERE from_id = '$dta[id]' AND kategori='UKM'");
                        ...
                        <div id="bg-post-loker" class="panel-collapse collapse in">
                            <div class="portlet-body">
                                <div class="row">
                                    ...
                                    <?php
                                    $get_kegiatan = mysqli_query($conn, "SELECT * FROM tb_kegiatan WHERE from_id = '$dta[id]' AND kategori='UKM'");
