...
$get_id = "";
$first_open = null;
$beasiswa = mysqli_query($conn, "SELECT * FROM tb_beasiswa ORDER BY id DESC");
// $dataArray = array();
...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Tambah Info Beasiswa</h4>
                        </div>
                        <div class="modal-body">
                            <form method="POST" action="controller/controller-beasiswa.php" enctype="multipart/form-data">


                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Judul</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="nb-edt form-control" required="" autocomplete="off" placeholder="Judul Info Beasiswa" name="judul" id="judul">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Batas Akhir</label>
                                    <div class="col-sm-10">
                                        <!-- <div class="input-group"> -->
                                        <input type="date" class="form-control" required="" placeholder="mm/dd/yyyy" name="batas_tanggal" id="datepicker">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" name="submit_tambah_beasiswa" class="btn btn-default waves-effect">Simpan</button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <a href="#" class="btn btn-default btn-rounded waves-effect waves-light m-b-30" data-toggle="modal" data-target="#con-close-modal">Tambah Info Beasiswa</a>
                        ...
                        <a href="#">
                            <div class="media">
                                <div class="media-left">
                                    <a href="../assets/images/beasiswa/<?= $dta['foto'] ?>" target="_blank"> <img class="media-object img-circle" alt="64x64" src="../assets/images/beasiswa/<?= $dta['foto'] ?>" style="width: 64px; height: 64px;"> </a>
                                </div>
                                <div class="media-body">
                                    <h4 class="media-heading"> <a href="beasiswa.php?selected_id=<?= $dta['id'] ?>"> <?= $dta['judul'] ?></a></h4>
                                    ...
                                    <p>
                                        <b>Batas Akhir:</b>
                                        <span class="text-muted"><?= $dta['batas_tanggal'] ?></span>
                                    </p>
            ...
            $result_selected = mysqli_query($conn, "SELECT * FROM tb_beasiswa WHERE id = '$get_id'");
            ...
            <div class="col-sm-8">
                <div class="card-box">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content bg-inverse">
                                ...
                                <div class="modal-footer justify-content-between">
                                    ...
                                    <a href="controller/controller-beasiswa.php?hapus_beasiswa=true&id=<?= $dta_selected['id'] ?>" type="button" class="btn btn-outline-dark" style="background-color: white;">Hapus</a>
                                </div>
                            </div>
                            <!-- /.modal-content -->
                        </div>
                    ...
                    <div class="product-right-info">
                        ...
                        <p> Tanggal : <?= $dta_selected['batas_tanggal'] ?></p>
                        <?php
